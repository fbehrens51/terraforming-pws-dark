...
runcmd:
  - |
    ...
    echo "OPTIONS=--collector.systemd --collector.ethtool --web.config.file=/etc/node_exporter/web-config.yml --web.listen-address=$LOCAL_IP:9100" > node_exporter_config
