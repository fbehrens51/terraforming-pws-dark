...
resource "aws_s3_bucket_object" "sshconfig_outside" {
  ...
  key          = "sshconfig_partial/${var.foundation_name}_${var.host_type}_sshconfig_outside"
...
resource "aws_s3_bucket_object" "sshconfig_bastion" {
  ...
  bucket       = var.secrets_bucket_name
  key          = "sshconfig_partial/${var.foundation_name}_${var.host_type}_sshconfig_bastion"
...
resource "aws_s3_bucket_object" "sshconfig_sjb" {
  ...
  bucket       = var.secrets_bucket_name
  key          = "sshconfig_partial/${var.foundation_name}_${var.host_type}_sshconfig_sjb"
