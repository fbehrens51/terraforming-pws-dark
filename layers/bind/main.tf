...
locals {
  ...
  pas_elb_dns                 = var.use_haproxy_router ? data.terraform_remote_state.pas.outputs.haproxy_elb_dns_name : data.terraform_remote_state.pas.outputs.pas_elb_dns_name
