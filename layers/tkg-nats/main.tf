...
module "nat" {
  ...
  private_route_table_ids    = data.terraform_remote_state.routes.outputs.tkg_private_vpc_route_table_ids
  ...
  public_subnet_ids          = data.terraform_remote_state.bootstrap_tkg.outputs.tkg_public_subnet_ids
