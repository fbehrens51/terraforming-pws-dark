...
module "director_blobstore_bucket_policy" {
  ...
  bucket_arn = data.terraform_remote_state.bootstrap_control_plane_foundation.outputs.director_blobstore_bucket_arn
}

resource "aws_s3_bucket_policy" "director_blobstore_bucket_policy_attachment" {
  bucket = data.terraform_remote_state.bootstrap_control_plane_foundation.outputs.director_blobstore_bucket
